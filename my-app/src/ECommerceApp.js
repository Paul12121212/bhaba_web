...
// import { Search, Filter, Grid, List, AlertCircle, X } from 'lucide-react';
...
const filteredProducts = useMemo(() => {
 ...
 return (
    ...
    className="text-xs sm:text-sm border border-gray-300 rounded-md px-2 py-1 focus:ring-blue-500 focus:border-blue-500"
  >
